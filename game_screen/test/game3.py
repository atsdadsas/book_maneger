...
def MovePlayer(Key,player,Nmap):
    if Key=='w':#上
        if Nmap[player[1]-1][player[0]]==0 or Nmap[player[1]-1][player[0]]==3:
            player[1]-=1
        elif Nmap[player[1]-1][player[0]]==2:
            print("\n*財宝見つけるまで帰るわけにはいかねぇ*\n")
        else:
            print("\n*壁だ*\n")

    elif Key=='a':#左
        if Nmap[player[1]][player[0]-1]==0 or Nmap[player[1]][player[0]-1]==3:
            player[0]-=1
        elif Nmap[player[1]][player[0]-1]==2:
            print("\n*財宝見つけるまで帰るわけにはいかねぇ*\n")
        else:
            print("\n*壁だ*\n")
...
while(1):
    match(scene):
        ...
        case 1:
            ...
            if pushKey=='p':
                break
            MovePlayer(pushKey,player,nowMap)
